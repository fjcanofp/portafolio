...
| Pool dinámico | `10.37.P.107 – 10.37.P.136` | `10.37.7.107 – 10.37.7.136` |
| Reserva | `10.37.P.183` | `10.37.7.183` |
| Lease / T1 / T2 | `1980 / 990 / 1732 s` | igual |
...
> Sustituye el contenido por un fichero equivalente a este ejemplo `P07-L03`.
...
El cliente debe recibir una IP del pool `10.37.7.107 – 10.37.7.136`.
...
Que **un cliente concreto** reciba siempre la misma IP: `10.37.7.183`.
...
El cliente reservado recibe **10.37.7.183**, aunque el pool normal sea `107–136`.
...
- `INTERFACES`: las dos NIC del relay.
...
El cliente B recibe una IP `10.38.7.x`.
...
### 3. ¿El servidor escucha en el puerto correcto?
...
| El test `-t` falla | JSON mal escrito |
...
La lógica de clasificación puede apoyarse en reservas, expresiones o atributos del cliente, y Kea permite usar clases para influir en selección de subred, pool u opciones. La documentación oficial explica que la clasificación puede aplicarse, entre otras cosas, a selección de subred y de pool【turn862439view1†L27-L44】.
...
La documentación oficial indica que Kea implementa funciones ampliables mediante **hook libraries**【turn862439view2†L8-L16】. En nuestra UT01, HA debe tratarse como **ampliación avanzada guiada**, no como primer laboratorio del alumno.
...
- Kea DHCPv4 server: instalación, validación y pruebas de configuración【turn862439view0†L9-L18】.
- Client Classification en Kea【turn862439view1†L18-L27】.
- Hook Libraries en Kea y ampliaciones avanzadas como HA【turn862439view2†L8-L16】.

## Información del material

**Autoría:** Fco. Javier Cano Granado  
**Revisión:** Fco. Javier Cano Granado  
**Versión:** 3.0  
